            ...
            <button  class="btn btn-default btn-back">返回列表</button>
                ...
                <form class="form-horizontal col-xs-12" role="form" action="<%=basePath%>v20/admin/workspace/createworkspace" method="post" >
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-xs-2 control-label">介绍地址</label>

                        <div class="col-xs-5">
                            <input type="text" id="introurl" name="introurl" value="${demand.introurl }" class="form-control">
                        </div>
                    </div>
                    ...
                    <!--  -->
                     ...
                     <!--  -->
                 	 <div id="bannerimg1" class="form-group">
                        <label class="col-xs-2 control-label">空间banner图</label>
						<!-- 制作类型 -->
                        <div class="col-xs-5">
                           	<input type="file" name="img" id="coverImg1" onchange="sendFile1()">
                           <img alt="空间banner图" id="coversrc1"
						src="<%=basePath %>v20/download/img?type=web&path="
						style="width: 180px;height: 180px;">
                           	<input type="hidden" name="bannerimg" id="bannerimg" value="0">
                        </div>
                    </div>
