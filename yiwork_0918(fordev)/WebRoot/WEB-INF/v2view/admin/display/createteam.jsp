    ...
    <div class="row row-flow member-add">
        <div class="form-group">
            <button  class="btn btn-default btn-back">返回列表</button>
                ...
                <form class="form-horizontal col-xs-12" name="mainform" id="mainform" action="<%=basePath%>v2/admin/display/saveteam"  method="post" onsubmit="return checkform(this);">
					<input type="hidden" id="id" value="${teaminfo.id}">
                    <div class="form-group">
                    ...
                    <div name="yixuantouxian" class="form-group">
                        <label class="col-xs-2 control-label">预览头像</label>
                    ...
                    <div class="form-group">
                     ...
                     <div name="yixuanfengmian" class="form-group">
                        <label class="col-xs-2 control-label">预览封面</label>
