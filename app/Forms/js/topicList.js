...
$(function(){
  ...
  //$('h3 > a').attr('href',root+'editor/app/Forms/topicBuild.html');
  $('h3 > a').attr('href','/topicBuild.html');
  $.ajax(
    'http://test.yi-gather.com:1717/v20/topic/findtopics', {
    //root + 'v20/group/findlistbygroup', {
      dataType: 'json',
      type: 'POST',
      data: {
        type : 'web',
      ...
      if (data.cord === 0) {
        ...
        $detail.on('click',function(){
          ...
          //location.href = root + "editor/app/Forms/topicDetail.html?id=" + $this.attr('id') + "&name=" + $this.html();
